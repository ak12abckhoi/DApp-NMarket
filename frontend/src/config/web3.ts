...
export const MARKETPLACE_ABI = [
  ...
  "function withdraw()",
  "function getListing(uint256 listingId) view returns (tuple(uint256,address,uint256,address,uint256,uint256,address,uint256,uint8,uint8))",
...
export const FACTORY_ABI = [
  ...
  "function getAllCollections() view returns (tuple(address,address,string,string,uint256)[])",
